    ...
    function videoBg($window, $q, $timeout) {
        return {
            ...
            link: function(scope, element) {
                ...
                var computedStyles,
                    ytScript = document.querySelector('script[src="https://www.youtube.com/iframe_api"]'),
                    ...
                    backgroundImage = scope.mobileImage || 'https://img.youtube.com/vi/' + scope.videoId + '/maxresdefault.jpg',
                    videoArr,
                    videoTimeout;
